...
class EdifyGenerator(object):
  ...
  def SetPermissions(self, fn, uid, gid, mode, selabel=None, capabilities=None):
  ...
  def SetPermissionsRecursive(self, fn, uid, gid, dmode, fmode, selabel=None, capabilities=None):
